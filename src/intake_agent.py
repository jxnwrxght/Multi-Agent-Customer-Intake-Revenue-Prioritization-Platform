...
class IntakeAgent:
    ...
    SERVICE_KEYWORDS = {
        "HVAC": ["ac", "air conditioning", "furnace", "heat", "hvac", "thermostat", "warm air", "gas smell", "air ducts"],
        "Plumbing": ["plumbing", "plumber", "toilet", "water heater", "tankless", "leak", "drain", "sink", "disposal", "water"],
        "Electrical": ["breaker", "outlet", "sparking", "power", "ev charger", "panel", "ceiling fan", "lights", "dryer"],
        "Cleaning": ["cleaning", "cleaner", "deep clean", "move-out clean", "office cleaning", "carpet", "janitorial", "maid", "house cleaning", "post-construction clean"],
    }
    SPAM_KEYWORDS = ["crypto", "guaranteed returns", "click this link", "remove me", "seo services", "business loan", "sponsored post", "buy followers"]
    EMERGENCY_KEYWORDS = ["emergency", "immediately", "as soon as possible", "asap", "now", "urgent", "today", "overflowing", "sparking", "gas smell", "no heat", "no power", "leaking from the ceiling", "backing up", "infant", "elderly"]
    ...
    EXISTING_CUSTOMER_KEYWORDS = ["existing customer", "last visit", "follow up", "follow-up", "warranty", "invoice", "came out", "installed last month"]
    ...
    def process(self, lead: dict[str, str]) -> IntakeResult:
        ...
        return IntakeResult(service_type, issue_summary, urgency, customer_intent, timing_need, missing_info)
