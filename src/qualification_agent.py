...
class QualificationAgent:
    ...
    def process(self, intake: IntakeResult) -> QualificationResult:
        ...
        revenue_generating = intake.customer_intent in {"Request service", "Request quote", "Book installation", "Request maintenance", "Existing customer follow-up"}
        ...
        lead_quality = self._classify_quality(intake, in_scope, revenue_generating, actionable, follow_up_needed)
        return QualificationResult(in_scope, revenue_generating, actionable, follow_up_needed, completeness, lead_quality)

    def _classify_quality(self, intake: IntakeResult, in_scope: bool, revenue_generating: bool, actionable: bool, follow_up_needed: bool) -> str:
